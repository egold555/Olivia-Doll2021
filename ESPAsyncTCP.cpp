...
#ifdef DEBUG_MORE
                                                 ,
                                                 _error_event_cb(NULL), _error_event_cb_arg(NULL)
#endif
{
}
...
#endif
                                                           ,
                                                           _pcb_sent_at(0), _close_pcb(false), _ack_pcb(true), _tx_unacked_len(0), _tx_acked_len(0), _tx_unsent_len(0), _rx_ack_len(0), _rx_last_packet(0), _rx_since_timeout(0), _ack_timeout(ASYNC_MAX_ACK_TIME), _connect_port(0), _recv_pbuf_flags(0), _errorTracker(NULL), prev(NULL), next(NULL)
{
  _pcb = pcb;
  if (_pcb)
  {
...
#if ASYNC_TCP_SSL_ENABLED
      ,
      _pending(NULL), _ssl_ctx(NULL), _file_cb(0), _file_cb_arg(0)
#endif
{
#ifdef DEBUG_MORE
